      ...
      //  PrintWriter out = response.getWriter();
        ...
        if( request.getParameter("logout")==null && request.getParameter("recjInformation")!=null){
            ...
            try {
                ...
                ResultSet rs = smt.executeQuery("select Job_Name, EmailID, Contact, BaseSalary, MinCPI, BranchPreffered, DateofVisit FROM signup JOIN For_Job on signup.RecruiterID= For_Job.RecruiterID");
