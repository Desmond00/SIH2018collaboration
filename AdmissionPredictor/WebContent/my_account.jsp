...
$(document).ready(function(){
	...
	<div>
	  <ul class="nav nav-pills" role="tablist">
	  	 <li class="active" role="presentation"><a href="#view" aria-controls="view" role="tab" data-toggle="tab">View details</a></li>
	...
	%>
		<form action="StudentServlet" method="post">
			<button  class="  btn btn-default btn-lg btn-block" type="submit" value="View your Information" name="yourInformation">View your Information</button><br/><br/>
			<button   class="btn btn-default btn-lg btn-block" type="submit" value="View Companies for Job" name="recjInformation">View Companies for Job</button><br/><br/>
			<button  class="btn  btn-default btn-lg btn-block" type="submit" value="View Companies for Internship" name="reciInformation">View Companies for Internship</button><br/><br/>
			<button  class="btn  btn-default btn-lg btn-block"  type="submit" value="View Eligible Companies" name="eligiblecomp">View Eligible Companies</button><br/><br/>
